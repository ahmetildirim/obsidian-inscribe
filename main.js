...
var StatusBarItem = class {
  ...
  render() {
    if (this.isGenerating) {
      ...
      (0, import_obsidian3.setTooltip)(this.statusBarItem, "Fetching completions...", { placement: "top" });
    } else {
