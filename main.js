...
var OllamaProvider = class {
  ...
  displaySettings(plugin, containerEl) {
    ...
    new import_obsidian2.Setting(containerEl).setName("Model").setDesc("Choose the Ollama model.").addDropdown((dropdown) => {
