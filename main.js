...
var StatusBarItem = class {
  ...
  displayContextMenu(event) {
    ...
    menu.addItem((item) => {
      item.setIsLabel(true).setTitle(`Completions`);
    });
    menu.addItem((item) => {
